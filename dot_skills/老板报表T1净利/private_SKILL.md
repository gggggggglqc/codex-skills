...
| 1 元人力产出 | `上月收入 / 人力成本总额`，四舍五入保留两位；人力成本总额取查询月 1 号之前该部门最新导入日期下的成本；国内上月收入取发货表国内收入，跨境上月收入只取净利 V2 `country_type=2` 且 `EP001` 的收入，产销特殊货主取产销导入/汇总收入 |
| 人力成本占比 | `人力成本总额 / 上月收入 × 100%` = `1 / 一元人力产出 × 100%`；收入分国内/跨境，人力成本不按国内/跨境拆分 |
