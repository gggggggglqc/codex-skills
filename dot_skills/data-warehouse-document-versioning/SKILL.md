...
先读取 `~/data-warehouse-agent/agents/document-version-management-agent.md`、`~/data-warehouse-agent/governance/versioning.md`、`~/data-warehouse-agent/sources/register.yaml`。
