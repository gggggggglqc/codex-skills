...
MYSQL_CONFIG = make_db_config(os.environ.get("MYSQL_PROFILE", "erp-mysql"), database="fms_cost", read_timeout=120)

DORIS_CONFIG = make_db_config(os.environ.get("DORIS_PROFILE", "doris"), database="dp_dws", read_timeout=120)
