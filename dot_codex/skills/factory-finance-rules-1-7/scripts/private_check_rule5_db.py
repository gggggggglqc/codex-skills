#!/usr/bin/env python3
"""Check rule 5 from MySQL.

Rule:
finished inbound unit cost * quantity = production cost management actual inbound total amount
...
production cost management amount:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Check rule 5 in MySQL")
    ...
    parser.add_argument(
        "--output",
        default="D:/codex/工厂账务核对/fms-reconciliation/output/rule5_2026_03.csv",
